...
$dazel_theme_divider_style = array(
...
$dazel_title                         =  'Untangle the future';
$dazel_subtitle                      =  'Bringing your imaginative ideas to life with boundless imagination and innovative thinking is a remarkable journey that thrives on the synergy of innovation.';
$dazel_theme_action_button           =   'Get Started';
$dazel_theme_action_button_secondary =  'Contact Sales';

$defaults = array(
	'default_icon'                      => $dazel_theme_svg_icons['fort-awesome'],
	'icons'                             => $dazel_theme_svg_icons,
	'divider_style'                     => $dazel_theme_divider_style,
	'gradients'                         => $dazel_gradients,

	'assets_js_key'                     => 'kubioFrontendData',

	'edit_this_text_in_customizer'      => $dazel_title,
	'lorem_ipsum'                       => $dazel_subtitle,
	...
	'front-header'                      => array(
		...
		'buttons'      => array(
			...
			'value' => array(
				array(
					'label'       => sprintf( $dazel_theme_action_button, 1 ),
					'url'         => '#',
					'button_type' => '0',
					'index'       => 0,
				),
				array(
					'label'       => sprintf( $dazel_theme_action_button_secondary, 1 ),
					'url'         => '#',
					'button_type' => '1',
					'index'       => 1,
				),
		...
		'subtitle'     => array(
			'show'  => true,
			'value'      => $dazel_subtitle,
			'localProps' => array(
				'content' => $dazel_subtitle
			),
			'style' => array(
				'descendants' => array(
					'text' => array(
						...
						'background' => array(
							...
							'overlay'   =>
								array(
									...
									'gradient'         => $dazel_gradients['night_fade'],
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $dazel_theme_svg_icons['facebook-square-full'],
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $dazel_theme_svg_icons['twitter-x'],
						'link_value' => '#',
						'index'      => 1,
					),
					array(
						'icon'       => $dazel_theme_svg_icons['youtube'],
						'link_value' => '#',
						'index'      => 2,
					),
					array(
						'icon'       => $dazel_theme_svg_icons['vimeo'],
						'link_value' => '#',
						'index'      => 3,
					),
				),
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $dazel_theme_svg_icons['map-marker'],
						'text'       => '123, Main Street, City, Country',
						'link_value' => 'https://maps.google.com/',
						'index'      => 0,
					),
					array(
						'icon'       => $dazel_theme_svg_icons['phone'],
						'text'       => '+1 234 567 890',
						'link_value' => 'tel:+1 234 567 890',
						'index'      => 0,
					),
					array(
						'icon'       => $dazel_theme_svg_icons['envelope'],
	...
	'header'                            => array(
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'icons' => array(
					...
					array(
						'icon'       => $dazel_theme_svg_icons['whatsapp-square'],
						'link_value' => '#',
						'index'      => 1,
					),
					array(
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $dazel_theme_svg_icons['map-pin'],
						'text'       => '1557 Frosty Lane, Binghamton, NY',
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $dazel_theme_svg_icons['phone-square'],
