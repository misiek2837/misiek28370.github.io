...
wp_localize_script(
	...
	array(
		...
		'builderStatusData' => array(
			'status'                          => dazel_theme()->getPluginsManager()->getPluginState( dazel_get_builder_plugin_slug() ),
			'install_url'                     => dazel_theme()->getPluginsManager()->getInstallLink( dazel_get_builder_plugin_slug() ),
			'activate_url'                    => dazel_theme()->getPluginsManager()->getActivationLink( dazel_get_builder_plugin_slug() ),
			'slug'                            => dazel_get_builder_plugin_slug(),
...
<div class="dazel-admin-big-notice--container">
	<div class="logo-holder">
        <h2><?php echo sprintf(__("Choose one of the %s predefined designs to start with:", 'dazel'), ucfirst(get_stylesheet())); ?></h2>
	</div>
	<div class="content-holder">
		<ul class="predefined-front-pages">
            ...
            $front_page_designs =  array(
                array(
                    'name'    => __( 'Modern', 'dazel' ),
                    'index'   => 1,
                    'preview' => 'front-page-1.jpg',
                ),

                array(
                    'name'    => __( 'Fullscreen', 'dazel' ),
                    'index'   => 2,
                    'preview' => 'front-page-2.jpg',
                ),

                array(
                    'name'    => __( 'Classic', 'dazel' ),
                    'index'   => 3,
            ...
            foreach ( $front_page_designs as $dazel_design_index => $design ) : ?>
				<?php
					$dazel_design_selected = $dazel_design_index === 0 ? 'selected' : '';
				...
				<li data-index="<?php echo esc_attr( $design['index'] ); ?>"
					class="<?php echo $dazel_design_selected; ?>">
                    ...
                    <div class="predefined-front-page-card">
						...
						<div class="front-page-design-wrapper">
							<div class="design-preview-image"
								 style="background-image: url(<?php echo esc_attr( dazel_theme()->getAssetsManager()->getBaseURL() . "/images/{$preview_image_name}" ); ?>)"
							></div>
						</div>
